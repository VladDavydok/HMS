  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setTotalAppointments(appointmentsData.appointments.length);

        const { data: doctorsData } = await axios.get(
          'http://localhost:4000/api/v1/user/doctors',
          { withCredentials: true }
        );
        setRegisteredDoctors(doctorsData.doctors.length);
      } catch (error) {
          ...
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>
                ...
                the desired result. Easy, for trouble. And these inconveniences
                did not help her. Necessities must therefore be repelled.
              </p>
            </div>
          </div>
